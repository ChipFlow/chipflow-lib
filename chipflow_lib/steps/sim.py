...
warnings.warn(
    "The 'chipflow_lib.steps.sim' module has been renamed to 'chipflow.platform'. "
    "Please update your imports to use 'chipflow.platform.SimStep' instead. "
...
from chipflow.platform import SimStep  # noqa: F401, E402
